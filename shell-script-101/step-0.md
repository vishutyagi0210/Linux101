...
Write bash-only syntax

Remove shebang

Run with sh

Explain failure in your own words.
...
What happens if the shebang points to a non-existent path?

Why is /bin/sh dangerous in Bash scripts?

How does cron decide which shell to use?
